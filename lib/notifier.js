    ...
    this.drawIcons = function(){
        ...
        this.button.instances.forEach(function(instance){
            ...
            if(self.logged === false && self.oldLoggedState !== self.logged){
                elem.style.listStyleImage = "url('resource://jid1-uzhilmjzsvxuug-at-jetpack/outlook-notifier/data/outlook-16-black-white.png')";
                ...
                elem.style.listStyleImage = "url('resource://jid1-uzhilmjzsvxuug-at-jetpack/outlook-notifier/data/outlook-16.png')";
